...
const Footer = () => {
  return (
    <div className=" bottom-0 relative footerBox ">
      <footer className="bg-gray-800 footer text-gray-50">
          ...
          <div className="flex flex-col justify-center pt-6 lg:pt-0">
            <div className="flex justify-center space-x-4">
              <a
                ...
                href="#"
                title="Instagram"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-yellow-500 text-gray-50"
              >
